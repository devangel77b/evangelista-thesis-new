...
4. Parachuting (drag based descent) \\ \index{parachuting}
5. Directed aerial descent (lift-based and drag-based; steep glide angles) \\ \index{directed aerial descent}
6. Gliding (predominantly lift-based; shallow glide angles) \\ \index{gliding}
7. Elaboration of wings and maneuvers \\
8. Flapping flight \\ \index{flapping}
\end{tabular}
\end{center}
\end{table}
...
\label{sec:Chukar}
\index{ontogeny} \index{aerial righting} \index{directed aerial descent} \index{Chukar}
